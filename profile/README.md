...
- **RF-08: Visualización y Filtro de la Agenda del Evento:** La aplicación debe renderizar de forma interactiva el cronograma completo de actividades, conferencias y talleres organizados por días. Permitirá a los asistentes filtrar los bloques horarios y los ponentes asignados en tiempo real, garantizando el acceso rápido a la información incluso en entornos de baja conectividad móvil.
- **RF-09: Sistema de Búsqueda Global y Filtrado del Evento:** La aplicación debe proveer un motor de búsqueda indexado que permita a los usuarios localizar información en tiempo real dentro de la plataforma. El sistema debe procesar consultas textuales sobre los comentarios, imágenes compartidas y videos publicados en el Feed de la aplicación.
- **RF-10: Carrete de Momentos en Tiempo Real (Estilo Historias):** La aplicación debe renderizar en la sección superior de la pantalla principal un componente de desplazamiento horizontal (carrusel) para la visualización de momentos efímeros. Este módulo agrupará cronológicamente las publicaciones multimedia de los asistentes y entidades del evento, implementando un diseño de avatares circulares con indicadores visuales de estados (leído/no leído), emulando el patrón de interfaz de usuario de las historias de Instagram.
- **RF-11: Captura y Publicación Directa:** El sistema debe permitir a las asistentes activar la cámara nativa del dispositivo al presionar el botón central del menú inferior. Una vez realizada la captura, la interfaz presentará la vista previa multimedia acompañada de un campo de entrada de texto opcional para que el usuario pueda redactar un pie de foto o descripción de hasta 500 caracteres. Finalmente, se desplegarán las opciones de Publicar (para subir el archivo adjunto junto con su texto al feed general) o Descartar (para descartar la captura y la edición). (Ampliación del RF-04).
- **RF-12: Perfil Usuarios:** El sistema debe permitir a los usuarios visualizar sus datos personales organizados en una interfaz inspirada en redes sociales, incluyendo foto de perfil, Ciudad/Departamento, número total de publicaciones realizadas y una cuadrícula (grid) con sus contenidos compartidos.
